...
![Commit activity](https://img.shields.io/github/contributors/mspr-ci/mspr-ci-application)
...
To build the final jar and optimize the msprCiApplication application for production, run:
...
Then navigate to [http://localhost:8341](http://localhost:8341) in your browser.
