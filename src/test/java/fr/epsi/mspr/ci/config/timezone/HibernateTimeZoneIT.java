package fr.epsi.mspr.ci.config.timezone;

import fr.epsi.mspr.ci.MsprCiApplicationApp;
import fr.epsi.mspr.ci.repository.timezone.DateTimeWrapper;
import fr.epsi.mspr.ci.repository.timezone.DateTimeWrapperRepository;
