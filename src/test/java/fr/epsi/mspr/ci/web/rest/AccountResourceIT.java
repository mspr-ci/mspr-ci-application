...
import fr.epsi.mspr.ci.config.Constants;
import fr.epsi.mspr.ci.domain.PersistentToken;
import fr.epsi.mspr.ci.domain.User;
import fr.epsi.mspr.ci.repository.AuthorityRepository;
import fr.epsi.mspr.ci.repository.PersistentTokenRepository;
import fr.epsi.mspr.ci.repository.UserRepository;
import fr.epsi.mspr.ci.security.AuthoritiesConstants;
import fr.epsi.mspr.ci.service.UserService;
import fr.epsi.mspr.ci.service.dto.PasswordChangeDTO;
import fr.epsi.mspr.ci.service.dto.UserDTO;
import fr.epsi.mspr.ci.web.rest.vm.KeyAndPasswordVM;
import fr.epsi.mspr.ci.web.rest.vm.ManagedUserVM;
...
import static fr.epsi.mspr.ci.web.rest.AccountResourceIT.TEST_USER_LOGIN;
